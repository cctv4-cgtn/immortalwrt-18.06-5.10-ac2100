...
foreach my $mirror (@ARGV) {
	if ($mirror =~ /^\@SF\/(.+)$/) {
		...
		push @mirrors, "http://debian-archive.trafficmanager.net/debian/$1";
		push @mirrors, "https://mirror.facebook.net/debian/$1";
		...
		push @mirrors, "https://mirrors.ocf.berkeley.edu/apache/$1";
		push @mirrors, "https://mirror.facebook.net/apache/$1";
      ...
      if (rand() < 0.33) {
		...
		push @mirrors, "https://mirrors.ocf.berkeley.edu/gnome/sources/$1";
